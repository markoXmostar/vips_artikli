...
import com.vanima.mvips.models.App2Dokumenti;
...
import com.vanima.mvips.models.AsortimanKupca;
            ...
            switch (tipPodataka) {
                ...
                case "jmj":
                    ...
                    try {
                        ...
                        ArrayList<com.vanima.mvips.models.jmj> ListaJmj = new ArrayList<jmj>();
                        for (int i = 0; i < arr.length(); i++) {
                            JSONObject myJmj = arr.getJSONObject(i);
