...
import com.example.marko.vips_artikli.models.App2Stavke;
...
import com.example.marko.vips_artikli.models.AsortimanKupca;
            ...
            switch (tipPodataka) {
                ...
                case "jmj":
                    ...
                    try {
                        ...
                        ArrayList<com.example.marko.vips_artikli.models.jmj> ListaJmj = new ArrayList<jmj>();
                        for (int i = 0; i < arr.length(); i++) {
                            JSONObject myJmj = arr.getJSONObject(i);
